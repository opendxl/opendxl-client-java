...
public abstract class Constants {
    ...
    /**
     * This system property can be set to {@code false} if the reconnect behavior should be disabled when the client
     * is unexpectedly disconnected from the broker.
     * <p>
     * This is equivalent to setting {@link DxlClient#setDisconnectedStrategy(DisconnectedStrategy)} to {@code null}
     * </p>
     */
